...
fimFightAreia14: 
	...
	addi $25, $0, 'w' #move para cima
     	addi $26, $0, 'd' #move para direita
     	addi $27, $0, 'a' #move para esquerda 	
...
acaoNigel:
	...
	beq $20, $25, bluePular
	lw $20, 4($28)
	beq $20, $26, blueAndarFrente
	lw $20, 4($28)
	beq $20, $27, blueAndarTras      
...
bluePular: 
	addi $6, $6, -3072 #diminui o valor do endereco do inicial do Blue
...
#funcao timer Acai
timerFightAcai: sw $25, 0($29)
	addi $29, $29, -4
	addi $25, $0, 10000
	
forTimerFightAcai: beq $25, $0, fimTimerFightAcai
	nop
	nop
	addi $25, $25, -1
	j forTimerFightAcai
