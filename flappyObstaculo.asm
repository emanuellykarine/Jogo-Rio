...
flappyCaindo:  #desenho do passáro
	       ...
	       beq $12, $15, fimDesenhoFlappy #se a cópia do cenario naquela posição for da cor da areia ele finaliza  
               ...
               #desenho do obstaculo	
 	       jal flappyObstaculoTopo

 	       jal copiaFlappyObstaculoTopo
	       beq $7, $9, fimDesenhoFlappy #se a copia do cenario for a cor do obstaculo termina
	       #------------------------
	       add $8, $8, $13 #diferença entre os endereços
	       addi $6, $6, -4 #diferença entre os obstaculos
...
flappyRandomico: lui $6, 0x1001 #endereço do obstaculo
	       	 addi $6, $6, 452 #final da tela 		
		 
		 addi $5, $0, 35 #limite do intervalo
