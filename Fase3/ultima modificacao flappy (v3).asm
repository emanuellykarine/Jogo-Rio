...
flappyVoar: addi $13, $0, -1536 # voltar o passáro dois endereços
...
fimCopiaFlappyObstaculosDistancia: addi $6, $6, -29184
 			 	   ...
 			 	   lui $6, 0x1001
			           addi $6, $6, 452
			           jal flappyRandomico 
			  	   jal flappyObstaculoTopo2

#função desenhar obstaculo no topo
flappyObstaculoTopo2:beq $23, $20, flappyEspacoObstaculos2
		     ...
		     j flappyObstaculoTopo2
		     
flappyEspacoObstaculos2: addi $6, $6, 6144 #diferença entre os obstaculos
			addi $20, $0, 0
			j flappyObstaculoInferior2
			
flappyObstaculoInferior2: beq $25, $20, flappyObstaculoFim2
