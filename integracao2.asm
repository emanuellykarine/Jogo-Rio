...
desenha_laranja:
	...
	j desenho_bluef1
p2f1: # desenha ma?? do lado esquerda superior
	beq $5 $0 desenho_bluef1
	addi $5 $5 -1
	lui $6, 0x1001
	ori $27, $0, 0xfa020c # vermelho ma??
...
acaoNigel:
	...
	jal desenhoAcai
        ...
        jal timerFightNigel
        lw $5, 988($8)
	beq $5, $15, fase2 #se o blue bater no bico do nigel ele perde
	...
	lw $5, 488($8)
	beq $5, $11, fimDesenhoFight #se parte de baixo do blue bater em cima do nigel ele ganha
	lw $5, 492($8)
        beq $5, $11, fimDesenhoFight
        lw $5, 496($8)
        beq $5, $11, fimDesenhoFight
...
fimflappyAreia4: 
	         lui $8, 0x1001 #reg do pass?ro com o endere?o inicial
	         addi $8, $8, 12380 # mover o pass?ro pro meio da tela
	 	 
	 	 lui $6, 0x1001 #endere?o do obstaculo
	       	 addi $6, $6, 224  		
		 
		 addi $13, $0, 512 #valor de diferen?a
		 
		 lui $21, 0xffff #teclado
		 addi $10, $0, 'w' #tecla pra levantar o pass?ro
		 
		 ori $15, $0, 0xFEE1A2 #cor da areia para colis?o
...
flappyCaindo:  beq $26, $0, flappyWin #se gerar 10 obstaculos o blue ganha
		...
		#desenho do pass?ro
	       ...
	       #c?pia e print do cen?rio
	       jal copiaFundoFlappy
	       
	       #addi $8, $8, 4 #move o blue pra frente  
	       beq $6, $24, flappyDistanciaObstaculos #se chegar em certa posi??o gera outro obstaculo
	       
	       beq $12, $15, fimDesenhoFlappy #se a c?pia do cenario naquela posi??o for da cor da areia ele finaliza 
	       
	       lw $27, 20($8)
	       beq $27, $9, fimDesenhoFlappy #se o endere?o do blue a frente for da cor do obstaculo ele perde
	       
	       lw $27, 3072($8)
	       beq $27, $9, fimDesenhoFlappy #se o endere?o do blue em baixo for da cor do obstaculo ele perde
	       ...
	       add $8, $8, $13 #diferen?a entre os endere?os do passaro
	       add $6, $6, -4 #diferen?a entre os endere?os do obstaculo
...
flappyVoar: addi $13, $0, -1536 # voltar o pass?ro tr?s endere?os

	     add $8, $8, $13 #diminui do endere?o
	     ...
	     #------------------
	     addi $13, $0, 512 #volta a somar o endere?o
	     j continuacaoFlappy

continuacaoFlappy: j flappyCaindo

flappyWin: addi $26, $0, 30 #movimnta??o do blue pro meio da tela
apagarFlappyObstaculos: beq $23, $20, copiaApagarFlappyObstaculos
			 ...
			 lw $7, 33032($6)
 			 ...
 			 addi $6, $6, 512 #diferen?a entre os endere?os
 			 addi $20, $20, 1 #quantidade de vezes que vai desenhar
 			  
 			 j apagarFlappyObstaculos
 			
copiaApagarFlappyObstaculos:  addi $6, $6, 6144 #diferen?a entre os obstaculos
			      addi $20, $0, 0
...
#fun??o gerar valores randomicos
...
#fun??o distancia dos obstaculos
...
copiaFlappyEspacoObstaculosDistancia:  addi $6, $6, 6144 #diferen?a entre os obstaculos
			      addi $20, $0, 0
...
#fun??o desenhar obstaculo no topo
...
flappyEspacoObstaculos: addi $6, $6, 6144 #diferen?a entre os obstaculos
			addi $20, $0, 0
...
#fun??o desenhar c?pia do fundo pros obstaculos
...
copiaFlappyEspacoObstaculos:  addi $6, $6, 6144 #diferen?a entre os obstaculos
			      addi $20, $0, 0
...
#fun??o desenho do pass?ro
desenhoFlappy: ori $11, $0, 0x546CF0 #azul do pass?ro
...
#desenho do fundo com as c?pias para a movimenta??o do pass?ro 
...
#fun??o desenho do pass?ro
desenhoFlappyJade: ori $11, $0, 0x4CADCD #azul do pass?ro
	       ori $14, $0, 0xFCFFFD #branco
	       ori $17, $0, 0x0C0D0D #preto
