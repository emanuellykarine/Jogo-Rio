...
#Nome dos laços/Localizadores: fightCeu, fimFightCeu, fightNuvemBr, fimFightNuvemBr, fightNuvemAz, fimFightNuvemAz, fightHorizonte, fimFightHorizonte, 
#fightMar, fimFightMar, fightPedra, fimFightPedra, fightEspuma, fimFightEspuma, fightAreia, fimFightAreia   
#Registradores usados: $6, $7, $8 (endereço de memória), $9 (cores cenário), $11, $12, $13, $14, $15, $16, $17, $18, $19 (cores personagens), 
#$20, $21 (contador), $22, $23, $24 (endereço temporário), $25 (valor da diferença entre endereços), $26 (timer)   
#Cores cenário: Azul céu: 0x62abd3 - Brnaco núvem/espuma: 0xfbfffe - Azul núvem: 0x82dbda - Azul mar horizonte: 0x0a6f98 - Azul mar escuro: 0x0f99c9 - Azul mar médio: 0x31c3da 
...
#Cinza bico Nigel: 0x464646 - Rosa Nigel: 0xBD768E - Amarelo Nigel: 0xF9BB0B - Roxo açaí: 0x9D09A5 
...
#acao nigel
	...
	addi $25, $0, -4 #subtra��o do endere�o do Nigel
acaoNigel:
	lui $20, 0x1001 #posicao inicial colisao do acai
	addi $20, $20, 29436 #posicao da colisoa 
	jal desenhoNigel
	jal desenhoAcai
	...
	add $8, $8, $25 #mudanca endereco Nigel

	addi $7, $7, -4 #mudanca de endere�o Acai 
	
	addi $21, $21, -1 #andar do Nigel -1
	beq $7, $20, fimAcai #checar se o aca� chegar na colisao vai pro fimAcai
	beq $21, $0, voltaNigel #se o andar o Nigel chegar 12 a frente, ele volta
	j acaoNigel
	
voltaNigel: 
	addi $20, $0, -1 #-1 para multiplicar o $25
	mul $25, $25, $20 #tornar o $25 em 4/-4 para o Nigel voltar na direcao contraria    
...
bluePulando: 
	...
	#desenho do acai 
	#jal fightObstaculo
#fightPular: #voltar o blue 5 enderecos acima
	#addi $23, $0, -2560
	#add $8, $8, $13 #diminui do endereco
	#jal desenhoBlue
	#jal copiaFundoFight
	#addi $23, $0, 2048 #volta a sormar o endereco
	#j continuacaoFight
#continuacaoFight: j fightPular
#fimDesenhoFight: jal desenhoBlue   	  
...
#desenho do fundo com as cópias para a movimentação do Nigel
copiaFundoNigel: 
	lw $22, 32768($8) #0($8)
	sw $22, 0($8) 
...
#funcao timer Nigel
timerFightNigel: sw $26, 0($29)
	addi $29, $29, -4
	addi $26, $0, 200000
	
forTimerFightNigel: beq $26, $0, fimTimerFightNigel
	nop
	nop
	addi $26, $26, -1
...
#funcao timer Acai
timerFightAcai: sw $26, 0($29)
	addi $29, $29, -4
	addi $26, $0, 100000
	
forTimerFightAcai: beq $26, $0, fimTimerFightAcai
	nop
	nop
	addi $26, $26, -1
	j forTimerFightNigel

fimTimerFightAcai: addi $29, $29, 4
	lw $26, 0($29)
	jr $31   
