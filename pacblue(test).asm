...
# Movimento do blue;
# $19, $20, $13, $14 -> teclas do jogo
# lw $10 endereço frente ao boneco 
# colisão eu acho que vai ter q ter um beq pare ver se o endereço seguinbte tem alguma cor
	dados_blue:
		ori $16, $0, 0xfffffe # branco
     		ori $17, $0, 0xb4b4b4 # bicos
     		ori $18, $0, 0x0000   # olho
     		ori $9, $0,  0x141d29 # Cor de fundo para rastros
     		ori $11, $0, 0x54cf0  # Azul claro blue
     		ori $12, $0, 0x333597 # Azul escuro blue
     		lui $6, 0x1001 # memoria do blue
     		lui $21 0xffff
		...
		j desenho_blue
     	dir:
     		addi $6 $6 +4
     		sw $9 14344($6)  # rastro esq
     		j desenho_blue
     	esq:
     		addi $6 $6 -4
     		sw $9 14352($6)  # rastro dir
     		j desenho_blue
     	cima:
     		addi $6 $6 -512
     		sw $9 14860($6)  # rastro baixo
     		j desenho_blue
     	baixo:
     		addi $6 $6 +512
     		sw $9 13836($6)  # rastro baixo
     		j desenho_blue
     	fim:
